...
<ButtonGroup.Root
	...
	class={cn(
		"absolute bottom-8 left-4 z-20 lg:bottom-4 [&_button]:rounded-3xl [&_button]:shadow-neu-depth [&_button]:corner-squircle [&_button]:dark:bg-card [&_button]:dark:hover:bg-secondary",
