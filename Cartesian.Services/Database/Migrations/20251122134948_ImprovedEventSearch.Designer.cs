...
namespace Cartesian.Services.Database.Migrations
{
    ...
    [Migration("20251122134948_ImprovedEventSearch")]
    partial class ImprovedEventSearch
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CartesianUserEventWindow", b =>
                {
                    b.Property<string>("ParticipantsId")
                        .HasColumnType("text");

                    b.Property<Guid>("ParticipatedWindowsId")
                        .HasColumnType("uuid");

                    b.HasKey("ParticipantsId", "ParticipatedWindowsId");

                    b.HasIndex("ParticipatedWindowsId");

                    b.ToTable("CartesianUserEventWindow");
                });
            ...
            modelBuilder.Entity("CartesianUserEventWindow", b =>
                {
                    ...
                    b.HasOne("Cartesian.Services.Events.EventWindow", null)
                        .WithMany()
                        .HasForeignKey("ParticipatedWindowsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
